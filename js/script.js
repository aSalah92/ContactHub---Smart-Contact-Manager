      ...
      if (!fullNameForm.test(fullName.value)) {
        ...
        if (!phoneNumberForm.test(phoneNumber.value)) {
          ...
          allContacts.length === 0
            ...
            : noContactsMsg.classList.add("d-none");
          //emptying inputs
          savedContactsContainer.innerHTML += HTMLNewContact;
          fullName.value = "";
          phoneNumber.value = "";
          email.value = "";
          address.value = "";
...
function applyFav(id) {
  ...
  console.log(allContacts[currentContactIndex]);
}
...
function deleteContact(id) {
  ...
  let deletedContactIndex = allContacts.findIndex((ele) => ele.id === id);
