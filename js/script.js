                ...
                <div id="${ele.id}" class="saved-contact-box">
                  ...
                  <div class="links-box">
                    <div class="two-sides-links contact-box">
                      <div class="call-box"><svg class="svg-inline--fa fa-phone" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="phone" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" data-fa-i2svg=""><path fill="currentColor" d="M164.9 24.6c-7.7-18.6-28-28.5-47.4-23.2l-88 24C12.1 30.2 0 46 0 64C0 311.4 200.6 512 448 512c18 0 33.8-12.1 38.6-29.5l24-88c5.3-19.4-4.6-39.7-23.2-47.4l-96-40c-16.3-6.8-35.2-2.1-46.3 11.6L304.7 368C234.3 334.7 177.3 277.7 144 207.3L193.3 167c13.7-11.2 18.4-30 11.6-46.3l-40-96z"></path></svg></div>
                      <div class="msg-box"><svg class="svg-inline--fa fa-envelope" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="envelope" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" data-fa-i2svg=""><path fill="currentColor" d="M48 64C21.5 64 0 85.5 0 112c0 15.1 7.1 29.3 19.2 38.4L236.8 313.6c11.4 8.5 27 8.5 38.4 0L492.8 150.4c12.1-9.1 19.2-23.3 19.2-38.4c0-26.5-21.5-48-48-48H48zM0 176V384c0 35.3 28.7 64 64 64H448c35.3 0 64-28.7 64-64V176L294.4 339.2c-22.8 17.1-54 17.1-76.8 0L0 176z"></path></svg></div>
                    </div>
                    <div class="two-sides-links defining-links">
                      <div id="fav-${ele.phoneNumber}" class="def-links fav-box" onclick="applyFav('fav-${ele.phoneNumber}')">
                      ...
                      <div id="emergency-${ele.phoneNumber}" class="def-links emergency-box" onclick="applyEmergency('emergency-${ele.phoneNumber}')">
          ...
          let HTMLNewContact = `
                <div id="${newContact.id}" class="saved-contact-box">
                  ...
                  <div class="links-box">
                    ...
                    <div class="two-sides-links defining-links">
                      <div id="fav-${newContact.phoneNumber}" class="def-links fav-box" onclick="applyFav('fav-${newContact.phoneNumber}')">
                      ...
                      <div id="emergency-${newContact.phoneNumber}" class="def-links emergency-box" onclick="applyEmergency('emergency-${newContact.phoneNumber}')">
                      ...
                      <div id="edit-${newContact.phoneNumber}" class="def-links edit-box" data-bs-toggle="modal" data-bs-target="#exampleModal"><svg class="svg-inline--fa fa-pen" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="pen" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" data-fa-i2svg=""><path fill="currentColor" d="M362.7 19.3L314.3 67.7 444.3 197.7l48.4-48.4c25-25 25-65.5 0-90.5L453.3 19.3c-25-25-65.5-25-90.5 0zm-71 71L58.6 323.5c-10.4 10.4-18 23.3-22.2 37.4L1 481.2C-1.5 489.7 .8 498.8 7 505s15.3 8.5 23.7 6.1l120.3-35.4c14.1-4.2 27-11.8 37.4-22.2L421.7 220.3 291.7 90.3z"></path></svg></div>
                      <div class="def-links delete-box" onclick="delMsg('contact${newContact.phoneNumber}')" data-bs-toggle="modal" data-bs-target="#exampleModal-del"><svg class="svg-inline--fa fa-trash" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="trash" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" data-fa-i2svg=""><path fill="currentColor" d="M135.2 17.7L128 32H32C14.3 32 0 46.3 0 64S14.3 96 32 96H416c17.7 0 32-14.3 32-32s-14.3-32-32-32H320l-7.2-14.3C307.4 6.8 296.3 0 284.2 0H163.8c-12.1 0-23.2 6.8-28.6 17.7zM416 128H32L53.2 467c1.6 25.3 22.6 45 47.9 45H346.9c25.3 0 46.3-19.7 47.9-45L416 128z"></path></svg></div>
                    </div>
                  </div>
                </div>`;
...
function delMsg(id) {
  deletedContact = document.getElementById(id);
  deletedContactIndex = allContacts.findIndex((ele) => ele.id === id);
